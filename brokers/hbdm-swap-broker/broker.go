...
func (b *HBDMSwapBroker) convertOrder(symbol string, order *hbdmswap.Order) (result Order) {
...
func (b *HBDMSwapBroker) orderDirection(order *hbdmswap.Order) Direction {
...
func (b *HBDMSwapBroker) orderType(order *hbdmswap.Order) OrderType {
	/*
...
func (b *HBDMSwapBroker) orderStatus(order *hbdmswap.Order) OrderStatus {
	/*
